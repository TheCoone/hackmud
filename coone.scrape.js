function (c, a) // t:#s.username.target
{
    ...
    if(a.i == 1){ return ts } else {

        ts = "\n" +
             " 1 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             " 2 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             " 3 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             " 4 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             " 5 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             " 6 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             " 7 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             " 8 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             " 9 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n" +
             "10 - crack {t:#s." + ts[Math.floor(Math.random() * 100)] + "}\n"
